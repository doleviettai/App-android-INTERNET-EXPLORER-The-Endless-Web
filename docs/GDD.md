...
- [`design-system.md`](./design-system.md) — hệ thống thiết kế "Terminal Noir" đầy đủ (màu sắc, typography, component, motion, accessibility)
- [`gameplay-mechanics-phase2.md`](./gameplay-mechanics-phase2.md) — spec chi tiết 4 cơ chế mở rộng (Trust & Leak Network, Trace Meter, Link Map, Site Decay)
...
#### 13.2.9. Visual Design System

Xem đầy đủ hệ thống thiết kế "Terminal Noir" (bảng màu, typography, motion, component spec, accessibility, voice) tại [`design-system.md`](./design-system.md) — tách riêng để dùng lại được ngoài phạm vi tài liệu này.
...
| **Phase 2 — Mở rộng** | Thêm 1–2 nhánh nội dung, Virus/Popup gắn cốt truyện, thêm 1 dạng puzzle, 4 cơ chế mới — xem [`gameplay-mechanics-phase2.md`](./gameplay-mechanics-phase2.md) | Mở rộng BatchGenerationService, thêm layout template mới |
